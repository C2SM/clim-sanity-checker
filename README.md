...
This command will:
 ...
 All testresults and plots generated by the clim-sanity-checker are stored in the *stages*-directory. In addition a logfile with the same output as printed to the terminal is stored in [logs](logs).
