...
#    
#    cmd = 'python sanity_test.py -v -e {} -t pattern_correlation --f_emis_ref stages/{} --p_ref_csv_files testsuite/ref --f_vars_to_extract vars_fldcor_test.csv -c -ts'.format(exp_name,ref_name)
#    print(cmd)
#
#    status, _ =utils.shell_cmd(cmd)
#
