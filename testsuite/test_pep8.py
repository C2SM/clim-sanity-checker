...
def test_lib():
    cmd = 'python testsuite/pycodestyle.py --exclude=paths.py --ignore=E265,W291,E201,E221,E231,E241,E722,W504,E731 lib/*.py'
    status, _ =utils.shell_cmd(cmd)
    assert status == 0, 'Violations of Pep-8-standard found!'

#def test_testsuite():
#    cmd = 'python testsuite/pycodestyle.py --ignore=E265,W291,E201,E221,E231,E241,E722,W504 testsuite/*.py'
#    status, _ =utils.shell_cmd(cmd)
#    assert status == 0, 'Violations of Pep-8-standard found!'
